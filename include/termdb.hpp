...
namespace tdb {
    ...
    public:
        ...
        TermDb(){
            ...
            // check if exceptions are on then throw in failure else set validstate to false    
        }
    ...
    template<Exceptions e>
    std::string TermDb<e>::parser(const std::string &s, param p1, param p2, param p3,
                            param p4, param p5, param p6, param p7, param p8,
                            param p9) const
    {
        const auto isDigit    = [](const char c) { return (c >= '0' && c <= '9'); };
    ...
    bool TermDb<e>::parse(const std::string _name, std::string _path)
    {
        ...
        template<Exceptions e>
        void TermDb<e>::_emulate_cup(const short jump = 1) const noexcept
        {
            if (jump > 0) {
                CONSOLE_SCREEN_BUFFER_INFO buffInfo;
                GetConsoleScreenBufferInfo(consoleHandle, &buffInfo);
        ...
        template<Exceptions e>
        void TermDb<e>::_emulate_cud(const short jump = 1) const noexcept
        {
            if (jump > 0) {
                CONSOLE_SCREEN_BUFFER_INFO buffInfo;
                GetConsoleScreenBufferInfo(consoleHandle, &buffInfo);
        ...
        template<Exceptions e>
        void TermDb<e>::_emulate_cuf(const short jump = 1) const noexcept
        {
            if (jump > 0) {
                CONSOLE_SCREEN_BUFFER_INFO buffInfo;
                GetConsoleScreenBufferInfo(consoleHandle, &buffInfo);
        ...
        template<Exceptions e>
        void TermDb<e>::_emulate_cub(const short jump = 1) const noexcept
        {
            if (jump > 0) {
                CONSOLE_SCREEN_BUFFER_INFO buffInfo;
                GetConsoleScreenBufferInfo(consoleHandle, &buffInfo);
        ...
        template<Exceptions e>
        void TermDb<e>::_emulate_cha(const short destCol = 1) const noexcept
        {
            if (destCol > 0) {
                CONSOLE_SCREEN_BUFFER_INFO buffInfo;
                GetConsoleScreenBufferInfo(consoleHandle, &buffInfo);
        ...
        template<Exceptions e>
        void TermDb<e>::_emulate_vpa(const short destRow) const noexcept
        {
            if (destRow > 0) {
                CONSOLE_SCREEN_BUFFER_INFO buffInfo;
                GetConsoleScreenBufferInfo(consoleHandle, &buffInfo);
        ...
        template<Exceptions e>
        void TermDb<e>::_emulate_cnorm() const noexcept
        {
        ...
        template<Exceptions e>
        void TermDb<e>::_emulate_civis() const noexcept
        {
        ...
        template<Exceptions e>
        void TermDb<e>::_emulate_cpl(const short jump = 1) const noexcept
        {
            if (jump > 0) {
                CONSOLE_SCREEN_BUFFER_INFO buffInfo;
                GetConsoleScreenBufferInfo(consoleHandle, &buffInfo);
        ...
        template<Exceptions e>
        void TermDb<e>::_emulate_cnl(const short jump = 1) const noexcept
        {
            if (jump > 0) {
                CONSOLE_SCREEN_BUFFER_INFO buffInfo;
                GetConsoleScreenBufferInfo(consoleHandle, &buffInfo);
